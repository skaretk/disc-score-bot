...
class PdgaPlayer:
    ...
    def __post_init__(self):
        if not self.pdga_number in range(1,500000): # 1-499999
        ...
        if not len(str(self.discord_id)) in range(16,23): # discord id's usually consist of 18 numbers. So we ensure that the format looks kinda valid at least.
